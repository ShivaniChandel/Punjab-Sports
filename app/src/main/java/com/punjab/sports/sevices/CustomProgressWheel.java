...
public class CustomProgressWheel extends View {
    private static final String TAG = CustomProgressWheel.class.getSimpleName();
    ...
    public CustomProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.CustomProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(
                R.styleable.CustomProgressWheel_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.CustomProgressWheel_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.CustomProgressWheel_barWidth,
                barWidth);

        rimWidth = (int) a.getDimension(R.styleable.CustomProgressWheel_rimWidth,
                rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.CustomProgressWheel_spinSpeed,
                spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.CustomProgressWheel_barSpinCycleTime,
                (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.CustomProgressWheel_barColor, barColor);

        rimColor = a.getColor(R.styleable.CustomProgressWheel_rimColor, rimColor);

        if (a.getBoolean(R.styleable.CustomProgressWheel_progressIndeterminate, false)) {
            spin();
        }
