...
public class Datamanger {
    ...
    public Datamanger() {
        //mService = ApiUtils.getDataManager();
    ...
    public void getCoachAccToCentre(final getCoachAccToCentremanager callback, String CenterId,String SportId,String subCatID) {

        mService = ApiUtils.createService(GetData.class);

        mService.getCoachAccToCentre(CenterId,SportId,subCatID).enqueue(new Callback<List<CoachAccToCentre>>() {
            @Override
