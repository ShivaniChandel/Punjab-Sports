...
import com.punjab.sports.sevices.MultiSelectionSpinner;
...
public class Register extends AppCompatActivity implements Datamanger.getregister, DialogSingleAlert.OnDoubleOptionAlertClickListener, Datamanger.getSportsAppliedFormanager, Datamanger.getCenterAccToSportmanager, Datamanger.getSubCategoryTospoSportmanager, Datamanger.getCoachAccToCentremanager, Datamanger.getSportsDistrictmanager, MultiSpinnerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getregister = this;
        getSportsAppliedFormanager = this;
        getCenterAccToSportmanager = this;
    ...
    Datamanger.getregister getregister;
    Datamanger.getSportsAppliedFormanager getSportsAppliedFormanager;
    Datamanger.getCenterAccToSportmanager getCenterAccToSportmanager;
    Datamanger.getCenterAccToSportmanager getSubCategoryTospoSport;
    Datamanger.getCoachAccToCentremanager getCoachAccToCentre;
    Datamanger.getSportsDistrictmanager getSportsDistrict;
    ...
    public void onSucess(registeration response) {
        try {
            ...
            //customDoubleOptionAlert(Register.this, response.getMessage(), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, false, Register.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
// we pass our item list and context to our Adapter.
    ...
    public void onFailure(String message) {
        try {
            ...
            showloader(false);
            customDoubleOptionAlert(Register.this, message, "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, false, Register.this);
    ...
    public boolean validation() {
        ...
        if (!isEmpty(name.getText().toString()) && !isEmpty(Aadhaar.getText().toString())
            ...
            if (isEmpty(name.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.namenotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
                ...
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.aadharnotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(fathername.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.fathernotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(mothername.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.mothernotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(dob.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.donnotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(class_pc.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.classnotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(city.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.citynotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(sstate)) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.statenotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            }/* else if (isEmpty(phone.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.phonenotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            }*/ else if (isEmpty(emergency.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.emergencynotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(sappiled)) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.appliednotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(scentre)) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.centrenotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(scoach)) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.coachnotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(username.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.usernotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(passward.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.passwordnotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(confpass.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.confpassnotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (!confpass.getText().toString().equalsIgnoreCase(passward.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.notmathch), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            } else if (isEmpty(address.getText().toString())) {
                value = false;
                customDoubleOptionAlert(Register.this, getResources().getString(R.string.addressnotfound), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, true, this);
            }
...
// Pass true If you want searchView above the list. Otherwise false. default = true.
        ...
        msportssubcategory.setItems(multipledata, this);
        ...
        if (isOnline(getApplicationContext())) {
            showloader(true);
            datamanager.getSportsDistrict(Register.this);
        } else {
            showloader(false);
            customDoubleOptionAlert(Register.this, getResources().getString(R.string.noNet), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, false, Register.this);
        }
                ...
                try {
                    if (response5.size() > 0)
                        if (!response5.get(position).getDistrictName().toString().equalsIgnoreCase("--Select--")) {
                            ...
                            if (isOnline(getApplicationContext())) {
                                showloader(true);
                                datamanager.getSportsAppliedFor(Register.this);
                            } else {
                                showloader(false);
                                customDoubleOptionAlert(Register.this, getResources().getString(R.string.noNet), "Ok", "Khedo Punjab", R.mipmap.ic_launcher, 1, false, Register.this);
                            }
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (response4.size() > 0)
                    if (!response4.get(position).getCoachName().equalsIgnoreCase("--Select--")) {
                        ...
                        adapter4 = new CoachAccToCentreAdapter(Register.this, response4);
                        coaches.setAdapter(adapter4);
*/
...
*/
                ...
                try {
                    if (isOnline(getApplicationContext())) {
                        ...
                        if (!String.valueOf(response3.get(position).getTcid()).equalsIgnoreCase("--Select--")) {
                            ...
                            Log.i("TAG", "======scentre=====" + scentre);
                            datamanager.getCoachAccToCentre(Register.this, String.valueOf(response3.get(position).getTcid()));
                        }
    ...
    public void onItemsSelected(List<KeyPairBoolData> items) {
        ...
        try {
            if (isOnline(getApplicationContext())) {
                showloader(true);
                datamanager.getCenterAccToSport(Register.this, sappiled, sstate, scategory);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
