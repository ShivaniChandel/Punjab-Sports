...
public class SportsappliedforAdapter extends ArrayAdapter<SportsAppliedFor> {

    public SportsappliedforAdapter(Context context,
                                   List<SportsAppliedFor> algorithmList)
    {
                          ...
                          ViewGroup parent)
    {
        ...
        SportsAppliedFor currentItem = getItem(position);

        // It is used the name to the TextView when the
        // current item is not null.
        if (currentItem != null) {
            textViewName.setText(currentItem.getSportName());
        }
        return convertView;
    }
}
